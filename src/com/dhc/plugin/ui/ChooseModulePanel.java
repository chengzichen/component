...
import com.dhc.plugin.util.ConfigureComponentInProjectUtilsKt;
...
public class ChooseModulePanel {
    ...
    public ChooseModulePanel(@NotNull Project project, @NotNull ComponentProjectConfigurator configurator, Collection<Module> excludeModules) {
        ...
        DefaultComboBoxModel hostMoudleBoxModel = new DefaultComboBoxModel();
    ...
    .reversed());
        ...
        hostMoudle.setModel(hostMoudleBoxModel);
    ...
    public List<Module> getHostModule() {
        ...
        String selectedItem = (String) hostMoudle.getSelectedItem();
        if (selectedItem == null) return Collections.emptyList();
        return Collections.singletonList(ModuleManager.getInstance(project).findModuleByName(selectedItem));
    }
}
