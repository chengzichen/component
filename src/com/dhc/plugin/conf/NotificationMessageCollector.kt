...
fun createConfigureComponentNotificationCollector(project: Project) =
        NotificationMessageCollector(project, "Configure Component: info notification", "Configure Component")